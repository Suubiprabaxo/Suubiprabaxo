...
- Integrações com sistemas externos (REST/SOAP)
- Bancos de dados (Oracle, MySQL, Redis)

📚 Boas práticas:
SOLID • Clean Code • Design Patterns

⚙️ Ferramentas:
Docker • Jenkins • SonarQube • Grafana • Jira

🎯 Sempre buscando evoluir e construir soluções eficientes e escaláveis.<br>
<br>
